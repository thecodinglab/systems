# taken and modified from: https://github.com/NixOS/nixpkgs/blob/5df43628fdf08d642be8ba5b3625a6c70731c19c/nixos/modules/services/networking/cloudflared.nix
{
  config,
  lib,
  pkgs,
...
let
  cfg = config.services.custom-cloudflared;
...
in
{
  options.services.custom-cloudflared = {
  ...
  config = lib.mkIf cfg.enable {
    ...
    ) config.services.custom-cloudflared.tunnels;
